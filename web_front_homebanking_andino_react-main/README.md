# Caja Piura — Banca por Internet (Homebanking)

Portal del **cliente final** de Caja Piura, construido en **React 18 + Vite (JavaScript)**.
Consume el backend FastAPI del Homebanking que corre en `http://localhost:8002`.

> Identidad visual de **Caja Piura**: isotipo institucional de la caja, paleta azul y dorado,
...
1. **Login** — tarjeta centrada con logo Caja Piura sobre el gradiente de marca y franja institucional.
